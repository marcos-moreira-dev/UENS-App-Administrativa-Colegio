...
public final class EstudiantesListViewModel {

    private final ObservableList<EstudianteListItemDto> items = FXCollections.observableArrayList();
    private final StringProperty statusText = new SimpleStringProperty("Cargando estudiantes...");
    ...
    public ObservableList<EstudianteListItemDto> items() {
        return items;
    }
