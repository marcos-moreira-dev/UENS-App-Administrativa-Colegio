...
/**
 * Define la responsabilidad de BusinessRuleException dentro del backend UENS.
...
/**
 * Construye la instancia de BusinessRuleException para operar en el modulo core.
 ...
 */
    public BusinessRuleException(ErrorCode errorCode, String message, Object details, Throwable cause) {
