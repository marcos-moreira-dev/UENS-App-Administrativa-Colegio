...
/**
 * Contrato de actualizacion de usuarios administrativos.
 */
public record UsuarioSistemaAdministrativoUpdateRequestDto(
        @NotBlank(message = "El login es obligatorio.")
        @Size(max = 80, message = "El login no debe exceder 80 caracteres.")
        String nombreLogin,

        @Size(min = 8, max = 120, message = "La contrasena debe tener entre 8 y 120 caracteres cuando se envia.")
        String password,
