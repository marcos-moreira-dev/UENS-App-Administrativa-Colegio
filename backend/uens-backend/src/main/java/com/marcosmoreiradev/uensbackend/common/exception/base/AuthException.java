...
/**
 * Define la responsabilidad de AuthException dentro del backend UENS.
...
/**
 * Construye la instancia de AuthException para operar en el modulo core.
 ...
 */
    public AuthException(ErrorCode errorCode, String message, Object details, Throwable cause) {
