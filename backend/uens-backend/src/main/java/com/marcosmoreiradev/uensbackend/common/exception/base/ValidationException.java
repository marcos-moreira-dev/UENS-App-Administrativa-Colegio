...
/**
 * Define la responsabilidad de ValidationException dentro del backend UENS.
...
/**
 * Construye la instancia de ValidationException para operar en el modulo core.
 ...
 */
    public ValidationException(ErrorCode errorCode, String message, Object details, Throwable cause) {
